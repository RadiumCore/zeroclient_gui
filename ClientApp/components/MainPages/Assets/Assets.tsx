...
import { CreateClassPopup } from '../AssetClasses/CreateClassPopup'
    ...
    get_content() {
        return <span>
            ...
            <div className="main-page-foot" >
                <button type="button" className="btn btn-default " onClick={this.ShowCreateAsset.bind(this)}>Create An Asset</button>
