...
import { NFT, NFT_command, blank_asset_command, asset_command_type } from '../_Interfaces/Assets'
...
import { TransferAssetPopupConfirmation } from "./TransferNFTPopupConfirmation"
...
export class TransferAssetPopup extends React.Component<Props, State>{
    ...
    validate() {
        ...
        if (this.state.command.destination == undefined) {
            this.setState({ show_info: true, info_title: "Error", info_body: "You must select a person to transfer this NFT to!" })
            return;
        }
