...
export class CreateUserPopupConfirmation extends React.Component<Props, CreateUserPopupConfirmationState>{
    constructor(props: Props) {
        ...
        api.EncodeNewUser(body, (data: any) => { this.setState({ encoding_result: data }); })
    }
