...
export class BuildTransactionComponent extends React.Component<Props, MultiSigState> {
    ...
    addinput() {
        ...
        api.GetInputValue(body, (data: any) => {
               
                    var newArray = this.state.inputs.slice();
                    var val: number = 0;
                    val = data["result"] as number;
    ...
    BuildTransaction() {
        ...
        api.PostCreateRawTransaction(body, (data: any) => {
            

            var rawtxid: string = "";
            rawtxid = data["result"] as string;
            if (rawtxid != "error") {
        ...
        return <Modal backdrop={"static"} show={true} onHide={this.props.close_callback}>
            ...
            <Modal.Body>
                ...
                <div className='row'>
                    <div className='col-sm-6'>
                        <button className="btn btn-default" onClick={this.addinput.bind(this)}>Add Input</button>
                    </div>
                ...
                <div className='row'>
                    <div className='col-sm-4'>
                        <button className="btn btn-default" onClick={this.addoutput.bind(this)}>Add output</button>
                    </div>
            ...
            <Modal.Footer>
                <div className="btn-toolbar" role="group" aria-label="...">
                    ...
                    <button className="btn btn-default" onClick={this.BuildTransaction.bind(this)}>Check Transaction</button>
                    <button className="btn btn-default" onClick={() => { this.props.close_callback(true) }}>Close</button>
                </div>
            </Modal.Footer>
        </Modal>
    }
